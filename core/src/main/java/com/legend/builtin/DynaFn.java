...
public enum DynaFn {
    ...
    CONTAINS("contains", Resolution.PURE, List.of("meta::pure::functions::string::contains", "meta::pure::functions::collection::contains"), Inference.MAPPED, Dialect.DEFAULT, Dialect.SNOWFLAKE, Dialect.SPANNER, Dialect.SPARKSQL, Dialect.SYBASEIQ),
    ...
    CURRENT_USER_ID("currentUserId", Resolution.PURE, List.of("meta::pure::functions::runtime::currentUserId"), Inference.NONE, Dialect.DEFAULT, Dialect.ORACLE, Dialect.SNOWFLAKE),
    ...
    EXISTS("exists", Resolution.PURE, List.of("meta::pure::functions::relation::exists", "meta::pure::functions::collection::exists"), Inference.MAPPED, Dialect.DEFAULT),
    ...
    FIRST("first", Resolution.PURE, List.of("meta::pure::functions::collection::first", "meta::pure::functions::relation::first"), Inference.NONE, Dialect.DEFAULT, Dialect.DUCKDB),
    ...
    IN("in", Resolution.PURE, List.of("meta::pure::functions::relation::in", "meta::pure::functions::collection::in"), Inference.MAPPED, Dialect.DEFAULT, Dialect.SPANNER),
    ...
    LAST("last", Resolution.PURE, List.of("meta::pure::functions::collection::last", "meta::pure::functions::relation::last"), Inference.NONE, Dialect.DEFAULT, Dialect.DUCKDB),
    ...
    MAX("max", Resolution.PURE, List.of("meta::pure::functions::math::max", "meta::pure::functions::date::max", "meta::pure::functions::collection::max"), Inference.MAPPED, Dialect.DEFAULT),
    ...
    MIN("min", Resolution.PURE, List.of("meta::pure::functions::math::min", "meta::pure::functions::date::min", "meta::pure::functions::collection::min"), Inference.MAPPED, Dialect.DEFAULT),
    ...
    PLUS("plus", Resolution.PURE, List.of("meta::pure::functions::string::plus", "meta::pure::functions::math::plus"), Inference.MAPPED, Dialect.DEFAULT, Dialect.SPANNER),
    ...
    TO_STRING("toString", Resolution.PURE, List.of("meta::pure::functions::string::toString"), Inference.MAPPED, Dialect.BIGQUERY, Dialect.CLICKHOUSE, Dialect.DATABRICKS, Dialect.DB2, Dialect.DUCKDB, Dialect.H2, Dialect.MEMSQL, Dialect.ORACLE, Dialect.POSTGRES, Dialect.PRESTO, Dialect.REDSHIFT, Dialect.SNOWFLAKE, Dialect.SPANNER, Dialect.SPARKSQL, Dialect.SQLSERVER, Dialect.SYBASE, Dialect.SYBASEIQ, Dialect.TRINO),
