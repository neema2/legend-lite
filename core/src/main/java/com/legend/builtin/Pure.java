...
public final class Pure {
    ...
    public static final NativeFunctionDefinition BETWEEN__NUMBER_1__NUMBER_1__NUMBER_1 = signature("native function meta::pure::functions::boolean::between(value:meta::pure::metamodel::type::Number[1], low:meta::pure::metamodel::type::Number[1], high:meta::pure::metamodel::type::Number[1]):meta::pure::metamodel::type::Boolean[1];");
    ...
    public static final NativeFunctionDefinition CONCAT__STRING_MANY = signature("native function meta::legend::lite::concat(strs:meta::pure::metamodel::type::String[*]):meta::pure::metamodel::type::String[1];");
    ...
    public static final NativeFunctionDefinition IS_NOT_NULL__T_1 = signature("native function meta::legend::lite::isNotNull<T>(val:T[1]):meta::pure::metamodel::type::Boolean[1];");
    public static final NativeFunctionDefinition IS_NULL__T_1 = signature("native function meta::legend::lite::isNull<T>(val:T[1]):meta::pure::metamodel::type::Boolean[1];");
    ...
    public static final NativeFunctionDefinition JOIN__RELATION_1__COL_SPEC_1__FUNCTION_1 = signature("native function meta::pure::functions::relation::join<S,T,A>(rel:meta::pure::metamodel::relation::Relation<S>[1], binding:meta::pure::metamodel::relation::ColSpec<A>[1], cond:meta::pure::metamodel::function::Function<{S[1],T[1]->meta::pure::metamodel::type::Boolean[1]}>[1]):meta::pure::metamodel::relation::Relation<S+A>[1];");
    ...
    public static final NativeFunctionDefinition LEGACY_NAVIGATE__RELATION_1__COL_SPEC_1__FUNCTION_1 = signature("native function meta::legend::lite::legacyNavigate<S,T,A>(rel:meta::pure::metamodel::relation::Relation<S>[1], binding:meta::pure::metamodel::relation::ColSpec<A>[1], cond:meta::pure::metamodel::function::Function<{S[1],T[1]->meta::pure::metamodel::type::Boolean[1]}>[1]):meta::pure::metamodel::relation::Relation<S+A>[1];");
    ...
    public static final NativeFunctionDefinition LEGACY_ASSOC_PREDICATE__A_1__B_1__FUNCTION_1 = signature("native function meta::legend::lite::legacyAssocPredicate<A,B>(a:A[1], b:B[1], cond:meta::pure::metamodel::function::Function<{meta::pure::metamodel::type::Any[1],meta::pure::metamodel::type::Any[1]->meta::pure::metamodel::type::Boolean[1]}>[1]):meta::pure::metamodel::type::Boolean[1];");
    ...
    // lite spelling of REAL pure hash(text, HashType.MD5) (functions::hash).
    public static final NativeFunctionDefinition MD5__STRING_1 = signature("native function meta::legend::lite::md5(str:meta::pure::metamodel::type::String[1]):meta::pure::metamodel::type::String[1];");
    ...
    public static final NativeFunctionDefinition NOT_EQUAL__ANY_MANY__ANY_MANY = signature("native function meta::legend::lite::notEqual(left:meta::pure::metamodel::type::Any[*], right:meta::pure::metamodel::type::Any[*]):meta::pure::metamodel::type::Boolean[1];");
    ...
    public static final NativeFunctionDefinition OVER__COL_SPEC_1__SORT_INFO_MANY__RANGE_1 = signature("native function meta::pure::functions::relation::over<T>(cols:meta::pure::metamodel::relation::ColSpec<T>[1], sortInfo:meta::pure::functions::relation::SortInfo<T>[*], range:meta::pure::functions::relation::_Range[1]):meta::pure::functions::relation::_Window<T>[1];");
    ...
    public static final NativeFunctionDefinition REPEAT_STRING__STRING_1__INTEGER_1 = signature("native function meta::pure::functions::string::repeatString(str:meta::pure::metamodel::type::String[1], count:meta::pure::metamodel::type::Integer[1]):meta::pure::metamodel::type::String[1];");
    ...
    // lite spelling of REAL pure hash(text, HashType.SHA1) (functions::hash).
    public static final NativeFunctionDefinition SHA1__STRING_1 = signature("native function meta::legend::lite::sha1(str:meta::pure::metamodel::type::String[1]):meta::pure::metamodel::type::String[1];");
    // lite spelling of REAL pure hash(text, HashType.SHA256) (functions::hash).
    public static final NativeFunctionDefinition SHA256__STRING_1 = signature("native function meta::legend::lite::sha256(str:meta::pure::metamodel::type::String[1]):meta::pure::metamodel::type::String[1];");
    ...
    public static final NativeFunctionDefinition TIME_BUCKET__DATE_1__INTEGER_1__DURATION_UNIT_1 = signature("native function meta::pure::functions::date::timeBucket(d:meta::pure::metamodel::type::Date[1], amount:meta::pure::metamodel::type::Integer[1], unit:meta::pure::functions::date::DurationUnit[1]):meta::pure::metamodel::type::Date[1];");
