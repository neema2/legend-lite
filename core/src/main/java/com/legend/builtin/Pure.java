...
public final class Pure {
    ...
    public static final NativeFunctionDefinition OVER__FRAME_1 = signature("native function meta::pure::functions::relation::over<T>(frame:meta::pure::functions::relation::Frame[1]):meta::pure::functions::relation::_Window<T>[1];");
    public static final NativeFunctionDefinition OVER__SORT_INFO_1__ROWS_1 = signature("native function meta::pure::functions::relation::over<T>(sortInfo:meta::pure::functions::relation::SortInfo<T>[1], rows:meta::pure::functions::relation::Rows[1]):meta::pure::functions::relation::_Window<T>[1];");
