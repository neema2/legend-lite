...
//
// DO NOT edit this file by hand. To add a native, add the signature here
// and re-run tests; if it parses, the constant lands in Pure.all().
...
public final class Pure {
    ...
    /** Snapshot of every Pure native def, alphabetical by constant name. */
    ...
    public static final NativeFunctionDefinition AVERAGE__RELATION_1__WINDOW_1__T_1 = signature("native function average<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition AVG__RELATION_1__WINDOW_1__T_1 = signature("native function avg<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition CORR__RELATION_1__WINDOW_1__T_1 = signature("native function corr<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition COUNT__RELATION_1__WINDOW_1__T_1 = signature("native function count<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):meta::pure::metamodel::type::Integer[1];");
    ...
    public static final NativeFunctionDefinition COVAR_POPULATION__RELATION_1__WINDOW_1__T_1 = signature("native function covarPopulation<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition COVAR_SAMPLE__RELATION_1__WINDOW_1__T_1 = signature("native function covarSample<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition GROUP__T_1 = signature("native function group<T>(val:T[1]):T[1];");
    ...
    public static final NativeFunctionDefinition MAX__RELATION_1__WINDOW_1__T_1 = signature("native function max<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition MEAN__RELATION_1__WINDOW_1__T_1 = signature("native function mean<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition MEDIAN__RELATION_1__WINDOW_1__T_1 = signature("native function median<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition MIN__RELATION_1__WINDOW_1__T_1 = signature("native function min<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition MODE__RELATION_1__WINDOW_1__T_1 = signature("native function mode<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition PERCENTILE__RELATION_1__WINDOW_1__T_1 = signature("native function percentile<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition STD_DEV_POPULATION__RELATION_1__WINDOW_1__T_1 = signature("native function stdDevPopulation<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition STD_DEV_SAMPLE__RELATION_1__WINDOW_1__T_1 = signature("native function stdDevSample<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition STD_DEV__RELATION_1__WINDOW_1__T_1 = signature("native function stdDev<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition SUM__RELATION_1__WINDOW_1__T_1 = signature("native function sum<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition VARIANCE_POPULATION__RELATION_1__WINDOW_1__T_1 = signature("native function variancePopulation<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition VARIANCE_SAMPLE__RELATION_1__WINDOW_1__T_1 = signature("native function varianceSample<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
    ...
    public static final NativeFunctionDefinition VARIANCE__RELATION_1__WINDOW_1__T_1 = signature("native function variance<T>(rel:meta::pure::metamodel::relation::Relation<T>[1], w:meta::pure::functions::relation::_Window<T>[1], r:T[1]):T[0..1];");
