...
| milestoning/tests | 221 | 61 | 7 | 100 | 53 |
...
- ERROR testMultipleBiTemporalPropertyUsageInProject [milestoning/tests]: milestoned property function 'biTemporalClassification' with an explicit date on a NESTED navigation is not supported yet
- ERROR testMultipleBiTemporalPropertyUsageInProjectWithMilestoningInfinityNotSpecifiedInDB [milestoning/tests]: milestoned property function 'biTemporalClassification' with an explicit date on a NESTED navigation is not supported yet
...
- ERROR testMilestoneFiltersAreNotAppliedToEmbeddedPropertiesInQualifiersTriggeringIsolationSelfJoin [milestoning/tests]: milestoned property function 'exchange' with an explicit date on a NESTED navigation is not supported yet
...
- ERROR testDerivedPropertyOnNonTemporalClassWithMilestonedChain [milestoning/tests]: milestoned property function 'leaves' with an explicit date on a NESTED navigation is not supported yet
...
- ERROR testMilestoneDateNotPropogatedThroughNonMilestonedType [milestoning/tests]: milestoned property function 'systemDescription' with an explicit date on a NESTED navigation is not supported yet
- ERROR testMilestoneDatePropogationThruExistsConditionalClause [milestoning/tests]: milestoned property function 'classification' with an explicit date on a NESTED navigation is not supported yet
...
- ERROR testBusinessTemporalRangeQueryOnRootAndPropertyDeep [milestoning/tests]: milestoned property function 'exchange' with an explicit date on a NESTED navigation is not supported yet
- ERROR testBusinessTemporalRangeQueryOnPropertyDeep [milestoning/tests]: milestoned property function 'exchange' with an explicit date on a NESTED navigation is not supported yet
...
- ERROR testChainedUnions [tests/mapping/union]: milestoned property function 'temporalEntityWithAddress' with an explicit date on a NESTED navigation is not supported yet
