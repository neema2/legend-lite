...
| calendarAggregation/tests | 92 | 34 | 0 | 53 | 5 |
...
- 45x Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
...
- ERROR testAnnualizedDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCmeDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCwDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCw_FmDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCyminus2DateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCyminus3DateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testMtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP12WaDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP12WtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP4WaDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP4WtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP52WtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP52WaDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP12MtdDateRange [calendarAggregation/tests]: Binder Error: No function matches the given name and argument types 'year(INTEGER_LITERAL)'. You might need to add explicit type casts. | 	Candidate functions: | 	year(DATE) -> BIGINT | 	year(INTERVAL) -> BIGINT | 	year(TIMESTAMP) -> BIGINT | 	year(TIMESTAMP WITH TIME ZONE) -> BIGINT |  |  | LINE 1:
- ERROR testPmaDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPmtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPqtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPriordayDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPrioryearDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPwDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPw_FmDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPwaDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPwtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPymtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPyqtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPytdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- SHAPE testPywaDateRange [calendarAggregation/tests]: assert form 'assertEquals/2' is not supported yet
- ERROR testPywtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testQtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testReportenddayDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testWtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testYtdDateRange [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testP12MtdValue [calendarAggregation/tests]: Binder Error: No function matches the given name and argument types 'year(INTEGER_LITERAL)'. You might need to add explicit type casts. | 	Candidate functions: | 	year(DATE) -> BIGINT | 	year(INTERVAL) -> BIGINT | 	year(TIMESTAMP) -> BIGINT | 	year(TIMESTAMP WITH TIME ZONE) -> BIGINT |  |  | LINE 1:
- ERROR testCwDateRangeOnSaturday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCw_FmDateRangeOnSaturday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPwDateRangeOnSaturday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPw_FmDateRangeOnSaturday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCwDateRangeOnSunday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testCw_FmDateRangeOnSunday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPriordayDateRangeOnSunday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPwDateRangeOnSunday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPw_FmDateRangeOnSunday [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPmaDateRangeOnStartYear [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPmtdDateRangeOnStartYear [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPqtdDateRangeOnStartYear [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPwaDateRangeOnStartYear [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testPywaDateRangeOnStartYear [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
- ERROR testFilterBeforeCalendar [calendarAggregation/tests]: Conversion Error: Unimplemented type for cast (DATE[] -> DATE) |  | LINE 1: ... UNNEST([CAST(list_min((SELECT LIST(t3.value) FROM ( SELECT CAST([t0.hireDate] AS DATE) AS value FROM EmployeeTable... |                                                                        ^
