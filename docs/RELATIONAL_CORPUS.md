...
- graphFetch/tests meta::relational::graphFetch::tests::crossDatabase::CrossMappingWithRelOpWithJoinKeys => [3697:1] association 'meta::relational::graphFetch::tests::crossDatabase::EmploymentAssociation': $that.ceoId has no column binding on the Relation mapping of 'meta::relational::graphFetch::tests::crossDatabase::Employee' (mapping=meta::relational::graphFetch::tests::crossDatabase::CrossMappingWithRelOpWithJoinKeys)
- graphFetch/tests meta::pure::graphFetch::tests::XStore::inMemoryAndRelational::crossMapping2 => [3751:1] XStore association 'meta::pure::graphFetch::tests::XStore::inMemoryAndRelational::Trade_TradeEvent' has direction-specific conditions; a single shared predicate is required for now (mapping=meta::pure::graphFetch::tests::XStore::inMemoryAndRelational::crossMapping2)
...
- graphFetch/tests meta::pure::graphFetch::tests::XStore::ordered::orderedCrossMapping3 => [3840:1] XStore/ModelJoin association end class 'meta::pure::graphFetch::tests::XStore::ordered::Trade' resolves to no Relation or Relational set for set id 'trade_set' in 'meta::pure::graphFetch::tests::XStore::ordered::orderedCrossMapping3'
...
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::NestedPropertyChainMapping => [3404:1] association 'meta::relational::tests::mapping::modelJoin::domain::Person_Firm': $employees.address has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::domain::Person' (mapping=meta::relational::tests::mapping::modelJoin::advanced::NestedPropertyChainMapping)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::DoubleNestedModelJoinMapping => [3404:1] association 'meta::relational::tests::mapping::modelJoin::domain::Person_Firm': $employees.address has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::domain::Person' (mapping=meta::relational::tests::mapping::modelJoin::advanced::DoubleNestedModelJoinMapping)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::RelationalNestedPropertyChainMapping => [3449:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::RelationalNestedPropertyChainMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::RelationalDoubleNestedMapping => [3449:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::RelationalDoubleNestedMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::RelationalFilterOnNestedMapping => [3449:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Firm' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::RelationalFilterOnNestedMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::FilterOnTargetMapping => [3449:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::FilterOnTargetMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::FilterOnTargetNestedConditionMapping => [3449:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::FilterOnTargetNestedConditionMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::DistinctOnTargetMapping => [3449:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::DistinctOnTargetMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::FilterWithInnerJoinOnTargetMapping => [3449:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::FilterWithInnerJoinOnTargetMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::MixedMappingNestedPropertyAccess => [3484:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::MixedMappingNestedPropertyAccess'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::QualifiedPropertyMapping => [3515:1] association 'meta::relational::tests::mapping::modelJoin::domain::Person_Firm': $employees.address has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::domain::Person' (mapping=meta::relational::tests::mapping::modelJoin::advanced::QualifiedPropertyMapping)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::NestedModelJoinWithPropertyAccess => [3515:1] association 'meta::relational::tests::mapping::modelJoin::domain::Person_Address': $person.profile has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::domain::Person' (mapping=meta::relational::tests::mapping::modelJoin::advanced::NestedModelJoinWithPropertyAccess)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::RelationalSimpleEqualityMapping => [3515:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::RelationalSimpleEqualityMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::advanced::ColumnCollisionMapping => [3515:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::advanced::ColumnCollisionMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::milestoning::MilestonedOrderWarehouseMapping => [3547:1] association 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order_Warehouse': $orders.product has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order' (mapping=meta::relational::tests::mapping::modelJoin::milestoning::MilestonedOrderWarehouseMapping)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::milestoning::MilestoningSameSchemeBothMapping => [3547:1] association 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order_Shipment': $order_ship.product has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order' (mapping=meta::relational::tests::mapping::modelJoin::milestoning::MilestoningSameSchemeBothMapping)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::milestoning::MilestoningDiffSchemeMapping => [3547:1] association 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order_Audit': $order_audit.product has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order' (mapping=meta::relational::tests::mapping::modelJoin::milestoning::MilestoningDiffSchemeMapping)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::milestoning::MilestonedIntermediatesMapping => [3547:1] association 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order_Shipment': $order_ship.milestonedProduct has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order' (mapping=meta::relational::tests::mapping::modelJoin::milestoning::MilestonedIntermediatesMapping)
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::milestoning::RelationalMilestonedOrderWarehouseMapping => [3547:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::milestoning::RelationalMilestonedOrderWarehouseMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::milestoning::RelationalMilestoningSameSchemeBothMapping => [3547:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::milestoning::RelationalMilestoningSameSchemeBothMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::milestoning::RelationalMilestoningDiffSchemeMapping => [3547:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::milestoning::domain::Order' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::milestoning::RelationalMilestoningDiffSchemeMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::simple::DerivedPropertyConditionMapping => [3740:1] association 'meta::relational::tests::mapping::modelJoin::domain::Person_Firm': $employees.fullName has no column binding on the Relation mapping of 'meta::relational::tests::mapping::modelJoin::domain::Person' (mapping=meta::relational::tests::mapping::modelJoin::simple::DerivedPropertyConditionMapping)
...
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::union::RelationalUnionSourceMapping => [3770:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::union::RelationalUnionSourceMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::union::RelationalUnionBothSidesMapping => [3770:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::union::RelationalUnionBothSidesMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::union::UnionWithExistsMapping => [3770:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::union::UnionWithExistsMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::union::UnionBothSidesMapping => [3771:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 2 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::union::UnionBothSidesMapping'
- tests/mapping/modelJoin meta::relational::tests::mapping::modelJoin::union::UnionPropertyInConditionMapping => [3771:1] XStore/ModelJoin association end class 'meta::relational::tests::mapping::modelJoin::domain::Person' resolves to 0 Relation(~func) set(s) in 'meta::relational::tests::mapping::modelJoin::union::UnionPropertyInConditionMapping'
...
- tests/mft/xStore meta::relational::tests::mapping::crossStore::model::mapping::mft::crossStoreTestMapping => [2584:1] Association mapping kind Cross not supported; mapping=meta::relational::tests::mapping::crossStore::model::mapping::mft::crossStoreTestMapping
