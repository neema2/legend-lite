...
- milestoning Class meta::relational::milestoning::TemporalMilestoningContext => [2609:119] expected ']' to close collection literal
...
- postprocessor Class meta::relational::mapping::PostProcessorResult => [2546:78] expected GREATER_THAN but found PIPE ('|')
...
- protocols/pure/v1_20_0/invocations Class meta::protocols::pure::v1_20_0::invocation::execution::execute::PropMapPrecalc => [2686:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_20_0/invocations Class meta::protocols::pure::v1_20_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2650:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_21_0/invocations Class meta::protocols::pure::v1_21_0::invocation::execution::execute::PropMapPrecalc => [2686:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_21_0/invocations Class meta::protocols::pure::v1_21_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2650:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_22_0/invocations Class meta::protocols::pure::v1_22_0::invocation::execution::execute::PropMapPrecalc => [2686:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_22_0/invocations Class meta::protocols::pure::v1_22_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2650:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_23_0/invocations Class meta::protocols::pure::v1_23_0::invocation::execution::execute::PropMapPrecalc => [2686:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_23_0/invocations Class meta::protocols::pure::v1_23_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2650:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_24_0/invocations Class meta::protocols::pure::v1_24_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_24_0/invocations Class meta::protocols::pure::v1_24_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_25_0/invocations Class meta::protocols::pure::v1_25_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_25_0/invocations Class meta::protocols::pure::v1_25_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_26_0/invocations Class meta::protocols::pure::v1_26_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_26_0/invocations Class meta::protocols::pure::v1_26_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_27_0/invocations Class meta::protocols::pure::v1_27_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_27_0/invocations Class meta::protocols::pure::v1_27_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_28_0/invocations Class meta::protocols::pure::v1_28_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_28_0/invocations Class meta::protocols::pure::v1_28_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_29_0/invocations Class meta::protocols::pure::v1_29_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_29_0/invocations Class meta::protocols::pure::v1_29_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_30_0/invocations Class meta::protocols::pure::v1_30_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_30_0/invocations Class meta::protocols::pure::v1_30_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_31_0/invocations Class meta::protocols::pure::v1_31_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_31_0/invocations Class meta::protocols::pure::v1_31_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_32_0/invocations Class meta::protocols::pure::v1_32_0::invocation::execution::execute::PropMapPrecalc => [2702:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_32_0/invocations Class meta::protocols::pure::v1_32_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2666:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/v1_33_0/invocations Class meta::protocols::pure::v1_33_0::invocation::execution::execute::PropMapPrecalc => [2699:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/v1_33_0/invocations Class meta::protocols::pure::v1_33_0::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2664:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- protocols/pure/vX_X_X/invocations Class meta::protocols::pure::vX_X_X::invocation::execution::execute::PropMapPrecalc => [2720:30] expected GREATER_THAN but found PIPE ('|')
- protocols/pure/vX_X_X/invocations Class meta::protocols::pure::vX_X_X::invocation::execution::testDataGeneration::SeedDataGenerationInput => [2678:29] expected BRACE_CLOSE but found EOF ('<EOF>')
...
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::metamodel::VarPlaceHolder => [2531:34] expected GREATER_THAN but found PIPE ('|')
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::metamodel::RelationFunctionColumn => [2621:57] expected GREATER_THAN but found PIPE ('|')
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::State => [3016:42] expected GREATER_THAN but found PIPE ('|')
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::ClassInstanceHolder => [3212:0] unsupported top-level keyword: PAREN_CLOSE (')')
...
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::metamodel::RelationFunction => [2540:1] Unknown type: 'meta::pure::mapping::relation::RelationFunctionInstanceSetImplementation' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::metamodel::TableAliasColumnName => [2540:1] Unknown type: 'TableAlias' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::metamodel::RelationalLambdaParameter => [2540:1] Unknown type: 'RelationalOperationElement' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::metamodel::RelationalLambda => [2540:1] Unknown type: 'RelationalLambdaParameter' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::metamodel::StaticPivot => [2598:1] Unknown type: 'meta::relational::metamodel::Literal' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::SelectWithCursor => [2734:1] Unknown type: 'SelectSQLQuery' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::FunctionParamScope => [2783:1] Unknown type: 'SelectWithCursor' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::ColumnGroup => [2783:1] Unknown type: 'RelationalOperationElement' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::MissingColProcessigRes => [2783:1] Unknown type: 'SelectWithCursor' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::OperationWithParentPropertyMapping => [2783:1] Unknown type: 'RelationalOperationElement' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::IsolationSelectState => [3126:1] Unknown type: 'JoinTreeNode' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::EnumProcessingHolder => [3126:1] Unknown type: 'ValueSpecification' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::MergeResultContainer => [3126:1] Unknown type: 'RelationalTreeNode' is not a known primitive, class, or enum
- pureToSQLQuery Class meta::relational::functions::pureToSqlQuery::JoinTreeMetaData => [3126:1] Unknown type: 'JoinTreeNode' is not a known primitive, class, or enum
