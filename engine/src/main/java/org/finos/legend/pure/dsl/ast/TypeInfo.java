...
public record TypeInfo(
    ...
    public static TypeInfo scalar() {
        return new TypeInfo(null, null, Map.of(), List.of(), List.of(), List.of(), false, null, null);
    }

    /** Creates a TypeInfo with type info but no mapping. */
    public static TypeInfo of(RelationType relationType) {
        return new TypeInfo(relationType, null, Map.of(), List.of(), List.of(), List.of(), false, null, null);
    }

    /** Full constructor with both type and mapping. */
    public static TypeInfo of(RelationType relationType, RelationalMapping mapping) {
        return new TypeInfo(relationType, mapping, Map.of(), List.of(), List.of(), List.of(), false, null, null);
    }
    ...
    public static TypeInfo structOf(RelationType relationType) {
        return new TypeInfo(relationType, null, Map.of(), List.of(), List.of(), List.of(), true, null, null);
    }
