...
import com.gs.legend.sql.*;

import java.util.ArrayList;
import java.util.List;
import java.util.function.Supplier;

import static com.gs.legend.sql.Token.*;

// TODO: Rewrite SQL compilation to parse SQL into ValueSpecification
// (same metamodel that Pure queries get parsed into via ValueSpecificationBuilder).
...
// Target flow: SQL → Druid parser → ValueSpecification → TypeChecker → PlanGenerator
