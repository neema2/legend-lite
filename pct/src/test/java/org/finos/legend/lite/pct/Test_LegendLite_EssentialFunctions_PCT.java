...
public class Test_LegendLite_EssentialFunctions_PCT extends PCTReportConfiguration {
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::collection::tests::find::testFindInstance_Function_1__Boolean_1_", "<CO_Person instanceOf meta::pure::functions::collection::tests::model::CO_Person>"),
            one("meta::pure::functions::collection::tests::find::testFindUsingVarForFunction_Function_1__Boolean_1_", "<CO_Person instanceOf meta::pure::functions::collection::tests::model::CO_Person>"),
            ...
            one("meta::pure::functions::collection::tests::head::testHeadComplex_Function_1__Boolean_1_", "\"Cannot find property 'lastName' on meta::pure::functions::collection::Pair\""),
            ...
            one("meta::pure::functions::collection::tests::zip::testZipBothListsAreOfPairs_Function_1__Boolean_1_", "\"no SQL type for generic Pair<meta::pure::functions::collection::Pair, meta::pure::functions::collection::Pair> at the lowering boundary\""),
            ...
            one("meta::pure::functions::collection::tests::zip::testZipFirstListsIsOfPairs_Function_1__Boolean_1_", "\"no SQL type for generic Pair<meta::pure::functions::collection::Pair, Integer> at the lowering boundary\""),
            ...
            one("meta::pure::functions::collection::tests::zip::testZipSecondListsIsOfPairs_Function_1__Boolean_1_", "\"no SQL type for generic Pair<Integer, meta::pure::functions::collection::Pair> at the lowering boundary\""),
